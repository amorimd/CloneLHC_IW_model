...
# use "./LHC_runII.py restore launch Results_folder_name" to restore impedance model results and launch DELPHI scans
# use "./LHC_runII.py restore retrieve Results_folder_name" to retrieve the results of DELPHI scans
...
if __name__ == "__main__":
    ...
    scenarioscan = np.array(['LHC_ft_6.5TeV_B1_2016','LHC_inj_450GeV_B1_2016']) 
    #scenarioscan=np.array(['LHC_highbeta_6.5TeV_B1_fill_5284_2016-09-07_20:15:00','LHC_highbeta_6.5TeV_B1_fill_5284_2016-09-07_20:20:00'])
    print scenarioscan
    dircollscan=scenarioscan; # name of the subdirectory created in ImpedanceWake2D folder
    
    optics_base_dir='/afs/cern.ch/user/d/damorim/work/GitIRIS/LHC_IW_model/Optics'

    optics_dir=optics_base_dir+'/2012/LHC-squeezer60cm/'    
    LHC2012_60cm=optics_dir+'LHC_beta_length_B'+beam+'_sq0p6m_3m_0p6m_3m.dat';
    
    optics_dir=optics_base_dir+'/2016/LHC-squeeze50cm/'
    LHC2016_50cm=optics_dir+'/twiss.lhc.b'+beam+'.coll6.5tev_50cm.thick_beta_elements.dat';
    
    optics_dir=optics_base_dir+'/2016/LHC-squeeze40cm/'
    LHC2016_40cm=optics_dir+'twiss.lhc.b'+beam+'.coll6.5tev_40cm.thick_beta_elements.dat';
       
    optics_dir=optics_base_dir+'/Optics/2015/LHC-ft'
    LHC2015_ft=optics_dir+'/twiss.lhc.b'+beam+'.ft6.5tev.thick_beta_elements.dat';
    
    optics_dir=optics_base_dir+'/2015/LHC-injection'
    LHC2015_inj=optics_dir+'/twiss.lhc.b'+beam+'.inj450gev.thick_beta_elements.dat';
    
    optics_dir=optics_base_dir+'/2016/LHC-HighBeta'
    LHC2016_ft_highbeta=optics_dir+'/twiss.lhc.b'+beam+'.coll6.5tev_highbeta.thick_beta_elements.dat';

    squeezescan=np.array([LHC2015_ft, LHC2015_inj])

    model=['Nominal LHC'  for ii in scenarioscan]; # case in LHC_param
    Escan=np.array([6500e9, 450e9]); # Energy
    #subscan=np.array([0])
    ...
    dampscan=np.array([0.0,0.02]); # damper gain scan
