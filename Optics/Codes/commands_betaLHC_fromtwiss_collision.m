...
% MBW, MQW) at 7TeV collision with squeeze of 0.55m
% NOTE: we use the coll3.5TeV twiss file even for 7TeV, since the beta
% functions are the same (the only difference will be from the experiments
% magnets but it has no impact, see commands_betaLHC_fromtwiss.m)
% The important thing is the squeeze to 0.55m (it is the only significant difference 
% between coll3.5tev and injection)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% dipoles beam screen
% around dipoles 
[sbegdip,senddip,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MB\.',15.495);
...
[sbegQfodo,sendQfodo,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQ\.(([23].)|(1[^01]))',5.8097);
...
[sbegQ8_10,sendQ8_10,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQ.*\.((8[RL][^37])|(10[RL][^37]))',7.0847);
...
[sbegQ9,sendQ9,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQM\.9[RL][^37]','MQMC\.9[RL][^37]'},8.4847);
...
[sbegQ11_IR1_3_5_7_R,sendQ11_IR1_3_5_7_R,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQ\.11R[1357]','MQTLI\.11R[1357]'},7.0847);
...
[sbegQ11_IR1_3_5_7_L,sendQ11_IR1_3_5_7_L,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQ\.11L[1357]','MQTLI\.11L[1357]'},7.0847);
...
[sbegQ11_IR2_4_6_8_R,sendQ11_IR2_4_6_8_R,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQ\.11R[2468]','MQTLI\.11R[2468]'},7.0847);
...
[sbegQ11_IR2_4_6_8_L,sendQ11_IR2_4_6_8_L,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQ\.11L[2468]','MQTLI\.11L[2468]'},7.0847);
...
[sbegQ7_8_10_IR3_7,sendQ7_8_10_IR3_7,namesQ7_8_10_IR3_7,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQ\.(([78][RL])|(10[RL]))','MQTLI\.(([78][RL])|(10[RL]))'},7.0847);
...
[sbegQ9_IR3_7,sendQ9_IR3_7,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQ\.9[RL]','MQTLI\.A9[RL]','MQTLI\.B9[RL]'},8.4847);
size(sbegQ9_IR3_7),names,sum(len),sum(sendQ9_IR3_7-sbegQ9_IR3_7)
% 4 BS. total BS length=33.938800000003539

% Q7 in IR4
[sbegQ7_IR4,sendQ7_IR4,namesQ7_IR4,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQM\.7[RL]',5.8097);
...
[sbegQ7_IR1_2_5_8,sendQ7_IR1_2_5_8,namesQ7_IR1_2_5_8,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQM\.A7[RL][1258]','MQM\.B7[RL][1258]'},9.4597);
...
%[sbegtest,sendtest,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MB\.',14.3);
%[avbetaxtest,avbetaytest]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbegtest,sendtest)
%[s,betax,betay,avbetax,avbetay,names,len]=meanbetatwiss('twiss.asbuilt.b1.coll3.5tev.thick','MB.');
...
[avbetax50A,avbetay50A]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbeg50A,send50A)
% avbetax50A= 86.2495 , avbetay50A= 91.1333
...
[sbegQ5_6_IR1_5,sendQ5_6_IR1_5,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQML\.[56][RL][15]',7.0847);
...
[sbegQ6_IR2_8,sendQ6_IR2_8,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQM\.6[RL][28]','MQML\.6[RL][28]'},10.8647);
...
[sbegQ6_IR3_7,sendQ6_IR3_7,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQTLH\.A6[RL][37]','MQTLH\.B6[RL][37]','MQTLH\.C6[RL][37]','MQTLH\.D6[RL][37]','MQTLH\.E6[RL][37]','MQTLH\.F6[RL][37]'},10.8647);
size(sbegQ6_IR3_7),names,sum(len),sum(sendQ6_IR3_7-sbegQ6_IR3_7)
% 4 BS. total BS length=43.458799999996700

% Q5 in IR2 (right) and IR8 (left) (two quads in each)
[sbegQ5_IR2R_8L,sendQ5_IR2R_8L,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQM\.A5[RL][28]','MQM\.B5[RL][28]'},11.8197);
...
[avbetax50L,avbetay50L]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbeg50L,send50L)
% avbetax50L= 172.4825 , avbetay50L= 159.1299
...
% Q1 in IR5 and IR8
[sbegQ1_IR5_8,sendQ1_IR5_8,namesQ1_IR5_8,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQXA\.1[RL][58]',8.6815-0.77-0.015);
...
[avbetax53V,avbetay53V]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbeg53V,send53V)
% avbetax53V=672.5918 , avbetay53V=672.5919
...
% Q1 in IR1 and IR2
[sbegQ1_IR1_2,sendQ1_IR1_2,namesQ1_IR1_2,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQXA\.1[RL][12]',8.6815-0.77-0.015);
...
[avbetax53H,avbetay53H]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbeg53H,send53H)
% avbetax53H=672.6174, avbetay53H=672.6178
...
[sbegUnd_IR4_R,sendUnd_IR4_R,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MU\.A5R4','MU\.B5R4','MU\.C5R4','MU\.D5R4'},1.3405);
...
[sbegQ4_5_IR6_Q5_6_IR4,sendQ4_5_IR6_Q5_6_IR4,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQY\.[456][RL][46]',6.1015);
...
% Q4 in IR1 and IR5
[sbegQ4_IR1_5,sendQ4_IR1_5,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQY\.4[RL][15]',8.7765);
size(sbegQ4_IR1_5),names,sum(len),sum(sendQ4_IR1_5-sbegQ4_IR1_5)
% 4 BS. total BS length=35.105999999999824

% Q3 in IR5 and IR8
[sbegQ3_IR5_8,sendQ3_IR5_8,namesQ3_IR5_8,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQXA\.3[RL][58]',9.744);
...
[sbegQ4_5_IR2_8,sendQ4_5_IR2_8,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQY\.A[45][RL][28]','MQY\.B[45][RL][28]'},12.1115);
...
[sbegQ2_IR5_8,sendQ2_IR5_8,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQXB\.A2[RL][58]','MQXB\.B2[RL][58]'},13.23);
...
[avbetax63V,avbetay63V]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbeg63V,send63V)
% avbetax63V=681.2085, avbetay63V=687.5515
...
% Q3 in IR1 and IR2
[sbegQ3_IR1_2,sendQ3_IR1_2,namesQ3_IR1_2,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MQXA\.3[RL][12]',9.744);
...
[sbegQ2_IR1_2,sendQ2_IR1_2,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick',{'MQXB\.A2[RL][12]','MQXB\.B2[RL][12]'},13.23);
...
[avbetax63H,avbetay63H]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbeg63H,send63H)
% avbetax63H=1435.8799, avbetay63H=1435.8865
...
[sbegD2_4_IR1_2_4_5_8,sendD2_4_IR1_2_4_5_8,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MBR((C\.4[RL][1258])|(B\.5[RL][4]))',10.7325);
...
% D3 in IR4 (in Q5)
[sbegD3_IR4,sendD3_IR4,namesD3_IR4,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MBRS\.5[RL]4',10.9895);
...
[avbetax69,avbetay69]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbeg69,send69)
% avbetax69=444.9043, avbetay69=424.6372
...
[sbegD1_IR2_8,sendD1_IR2_8,names,len]=extract_beamscreens('twiss.asbuilt.b1.coll3.5tev.thick','MBX\.4[RL][28]',10.8325);
...
[avbetax74,avbetay74]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbeg74,send74)
% avbetax74=597.6723, avbetay74=597.6730
...
% type 50A
halfgap50A=36.75/2;lengt50A=2.19920348e+04;avbetax50A=86.2495;avbetay50A=91.1333;
% type 50L
halfgap50L=37.55/2;lengt50L=167.2346;avbetax50L=172.4825;avbetay50L=159.1299;
% type 53V
halfgap53V=40.35/2;lengt53V=31.586;avbetax53V=672.5918;avbetay53V=672.5919;
% type 53H
halfgap53H=40.35/2;lengt53H=31.586;avbetax53H=672.6174;avbetay53H=672.6178;
% type 63V
halfgap63V=50.45/2;lengt63V=284.2195;avbetax63V=681.2085;avbetay63V=687.5515;
% type 63H
halfgap63H=50.45/2;lengt63H=94.976;avbetax63H=1435.8799;avbetay63H=1435.8865;
% type 69
halfgap69=56.15/2;lengt69=130.6445;avbetax69=444.9043;avbetay69=424.6372;
% type 74
halfgap74=60.95/2;lengt74=64.61;avbetax74=597.6723;avbetay74=597.6730;


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MBW and MQW (copper, warm) at coll3.5tev
...
% MBW
[s,betax,betay,avbetaxMBW,avbetayMBW,namesMBW,lenMBW,sbegMBW,sendMBW]=meanbetatwiss('twiss.asbuilt.b1.coll3.5tev.thick','MBW');
...
%[avbetax,avbetay]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbegMBW,sendMBW)
% same result

% MQW
[s,betax,betay,avbetaxMQW,avbetayMQW,namesMQW,lenMQW,sbegMQW,sendMQW]=meanbetatwiss('twiss.asbuilt.b1.coll3.5tev.thick','MQW');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% rest of the machine (where warm pipe) at coll3.5tev
...
[avbetaxrest,avbetayrest]=meanbetatwiss2('twiss.asbuilt.b1.coll3.5tev.thick',sbegrest,sendrest)
% avbetaxrest=342.293, avbetayrest=343.5179
