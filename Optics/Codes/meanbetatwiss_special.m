function [s,betax,betay,avbetax,avbetay,varargout]=meanbetatwiss_special(twissname,varargin);
...
%
% special case for HL-LHC files from S. Fartoukh (2 less columns, length
% not given -> found from s)

ncol=10; % number of columns in twiss file. if changed, change also lines 27, 30 and 59 accordingly
