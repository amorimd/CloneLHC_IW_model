function [avbetax,avbetay]=meanbetatwiss2_special(twissname,sbeg,send);
...
ncol=10; % number of columns in twiss file. if changed, change also lines 17, 20 and 43 accordingly
